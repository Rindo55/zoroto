...
Currently serving at [Zoro Community](https://t.me/joinchat/Cd6xjR_S7wpkM2Rl).""",
        ...
        await client.send_sticker(gid, "CAACAgUAAxkBAAESua9jZALoJKTixzJ4jO_5ZeErM8T1CAACYgEAAmqEPDameGJhwx8w4SoE")
...
async def feed_(client: anibot, message: Message, mdata: dict):
    ...
    await client.send_message(mdata['chat']['id'], f"For issues or queries please contact @{owner}")
